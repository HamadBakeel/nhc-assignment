...
const CardItem = ({ product }: { product: TProduct }) => {
    ...
    return (
        <div className="max-w-sm rounded-[10px] overflow-hidden shadow-product-card bg-white p-2 pb-4 m-auto mb-6">
            ...
            <div className="">
                ...
                <div className="flex justify-between items-center mt-4">
                    ...
                    <Link href={'/products/'+product.id} className="bg-[#285F9D] text-white text-sm px-4 py-2 rounded-md">More</Link>
                </div>
            </div>
        </div>
    )
